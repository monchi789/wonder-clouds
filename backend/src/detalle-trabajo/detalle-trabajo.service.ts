...
export class DetalleTrabajoService {
    ...
    async remove(idDetalleTrabajo: string) {
        const detalleTrabajo = await this.detalleTrabajoRepository.softDelete(idDetalleTrabajo);
        ...
        return { message: `DetalleTrabajo con el id ${idDetalleTrabajo} eliminado.` };
    }
}
