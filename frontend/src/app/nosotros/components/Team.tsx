...
const Team = () => {
  ...
  return (
    <motion.div
      className="container flex flex-col w-full lg:w-3/4 items-center relative space-y-20 mx-auto mt-24 px-5"
      initial="hidden"
      whileInView="visible"
      variants={fadeInUp}
    ...
    >
      ...
      >
        ...
        <motion.p
          className="w-2/3 text-lg text-default font-medium"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, ease: "easeOut" }}
          viewport={{ once: true, amount: 0.2 }}
        >
          En WonderClouds, nuestro equipo de élite está compuesto por los mejores en el campo del marketing digital.
