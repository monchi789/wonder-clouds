...
export default function Home() {
  ...
  return (
    <div className="relative">
      ...
      <div className="container flex flex-row w-full lg:w-full items-center px-auto mx-auto my-12 lg:mt-5 space-y-10 relative">
      ...
      <div className="flex flex-col justify-center items-center text-white bg-[#104D7E] space-y-5 p-10 ">
        <h1 className="text-5xl">Wonder Clouds</h1>
